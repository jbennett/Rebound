...
?>
  ...
  <div class="page-wrapper"><div><div>
    ...
    <div class="footer"><div><div><div>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="logo">
            <img src="<?php print $base_path.path_to_theme(); ?>/img/logo-rebound2.png" alt="<?php print $site_name; ?>" />
        </a>
      <?php print render($page['footer']); ?>
      <a class="site-by-cci" href="http://ccistudios.com" target="_blank">Website by <span>CCI Studios</span></a>
